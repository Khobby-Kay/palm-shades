...
CREATE TABLE "Booking" (
    ...
    "location" TEXT NOT NULL DEFAULT 'IN_SALON',
    "address" TEXT,
    "notes" TEXT,
...
CREATE TABLE "GalleryItem" (
    ...
    "variant" TEXT NOT NULL DEFAULT 'rose',
    "position" INTEGER NOT NULL DEFAULT 0,
    "isActive" BOOLEAN NOT NULL DEFAULT true,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- AddForeignKey
ALTER TABLE "Booking" ADD CONSTRAINT "Booking_childId_fkey" FOREIGN KEY ("childId") REFERENCES "ChildProfile"("id") ON DELETE SET NULL ON UPDATE CASCADE;
