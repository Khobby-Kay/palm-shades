                ...
                {images.map((image, index) => (
                  <div key={index} className="relative group">
                    <div className="relative aspect-square overflow-hidden rounded-xl border-2 border-gray-200 bg-gray-100">
                      <CoverImage src={image} alt={`Product ${index + 1}`} sizes="(max-width: 768px) 33vw, 20vw" />
                    </div>
                    {index === 0 && (
            ...
            <div className="space-y-6 max-w-3xl">
              ...
              <div>
                ...
                <textarea
                  rows={3}
                  maxLength={500}
                  defaultValue="Premium beauty product from Palm Shades. Salon-tested quality for hair, skin, and everyday glam."
                  className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none"
                />
              ...
              <div>
                ...
                <div className="flex items-center">
                  <span className="text-gray-600 bg-gray-100 px-4 py-3 border-2 border-r-0 border-gray-300 rounded-l-lg">
                    {(process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000').replace(/^https?:\/\//, '').replace(/\/$/, '')}/product/
                  </span>
                  <input
                    type="text"
              ...
              <div>
                ...
                <input
                  type="text"
                  defaultValue="Palm Shades, Palm Shades, beauty boutique Accra, hair care, skin care, makeup Ghana"
                  className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                />
