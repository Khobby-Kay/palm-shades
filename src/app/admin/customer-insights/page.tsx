...
import {
  exportCustomerInsightsCsv,
  exportCustomerInsightsPdf,
  type CustomerInsightExportRow,
...
function CustomerInsightsAdmin() {
  ...
  const toExportRows = (list: typeof customers): CustomerInsightExportRow[] =>
    list.map((c) => ({
      name: c.name,
      email: c.email,
      phone: c.phone,
  ...
  const handleExportCsv = () => {
    exportCustomerInsightsCsv(toExportRows(filteredCustomers));
  };
  ...
  const handleExportPdf = () => {
    const segmentLabel =
      selectedSegment === 'all'
        ? 'Customer Insights'
        : `Customer Insights — ${getSegmentLabel(selectedSegment)}`;
    exportCustomerInsightsPdf(toExportRows(filteredCustomers), segmentLabel);
  };
...
export default function CustomerInsightsPage() {
  return (
    <ModuleGate moduleId="customer-insights">
