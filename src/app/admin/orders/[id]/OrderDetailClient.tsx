  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="print-section hidden print:block bg-white p-8">
        <MotchisPrintChrome
          documentTitle="Order Packing Slip"
          reference={order?.order_number}
          date={order ? new Date(order.created_at).toLocaleString('en-GH') : undefined}
        >
          {/* Ship To */}
          <div className="mb-6">
              ...
              <div className="space-y-4">
                {order.order_items?.map((item: any) => (
                  <div key={item.id} className="flex items-start space-x-4 p-4 bg-gray-50 rounded-lg">
                    <div className="relative flex h-20 w-20 items-center justify-center overflow-hidden rounded-lg border border-gray-200 bg-white">
